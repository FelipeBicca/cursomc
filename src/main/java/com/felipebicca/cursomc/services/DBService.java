...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Produto p7 = new Produto(null, "TV True Blue", 1200.00);
		Produto p8 = new Produto(null, "Roçadeira", 800.00);
		Produto p9 = new Produto(null, "Abajur", 100.00);
		Produto p10 = new Produto(null, "Pendente", 180.00);
		Produto p11 = new Produto(null, "Shampoo", 90.00);
		Produto p12 = new Produto(null, "Ray-Ban", 899.00);
		...
		cli2.getTelefones().addAll(Arrays.asList("32335025", "991254000"));
		
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Av. Matos", "105", "Sala 800", "Centro", "98777012", cli1, c2);
		Endereco e3 = new Endereco(null, "Rua Andradas", "79", null, "Centro", "96200030", cli2, c3);
